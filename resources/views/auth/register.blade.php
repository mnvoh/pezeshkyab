    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 login-form">
            ...
            <form action="#" method="post">
                ...
                <div class="form-group">
                    <label for="license" class="control-label">
                        {{ trans('main.physician_license_number') }}
                        <span class="text-danger">*</span>
                    </label>

                    <input type="text" name="license" id="license" class="form-control"
                           placeholder="{{ trans('main.physician_license_number') }}" value="{{ old('license') }}" />
                </div>
                ...
                <div class="form-group">
                    <label for="ban" class="control-label">
                        {{ trans('main.bank_account_number') }}
                        <span class="text-danger">*</span>
                    </label>

                    <input type="text" name="ban" id="ban" class="form-control"
                           placeholder="{{ trans('main.bank_account_number') }}" value="{{ old('ban') }}" />
                </div>

                <div class="form-group">
                    <label for="mobile" class="control-label">
                        {{ trans('main.mobile_number') }}
                        <span class="text-danger">*</span>
                    </label>

                    <input type="text" name="mobile" id="mobile" class="form-control"
                           placeholder="{{ trans('main.mobile_number') }}" value="{{ old('mobile') }}" />
                </div>
                    ...
                    <div class="form-control">
                        <div class="col-xs-4">
                            <input type="text" name="bd_year" id="bd_year" class="noborder transparent"
                                   placeholder="{{ trans('main.year') }}" value="{{ old('bd_year') }}" />
                        </div>
                        <div class="col-xs-4">
                            <input type="text" name="bd_month" id="bd_month" class="noborder transparent"
                                   placeholder="{{ trans('main.month') }}" value="{{ old('bd_month') }}" />
                        </div>
                        <div class="col-xs-4">
                            <input type="text" name="bd_date" id="bd_date" class="noborder transparent"
                                   placeholder="{{ trans('main.day') }}" value="{{ old('bd_date') }}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="street_address1" class="control-label">
                        {{ trans('main.street_addr_1') }}
                        <span class="text-danger">*</span>
                    </label>
                    <input type="text" name="street_address1" id="street_address1" class="form-control"
                           placeholder="{{ trans('main.street_addr_1') }}" value="{{ old('street_address1') }}" />
                </div>

                <div class="form-group">
                    <label for="street_address2" class="control-label">
                        {{ trans('main.street_addr_2') }}
                    </label>
                    <input type="text" name="street_address2" id="street_address2" class="form-control"
                           placeholder="{{ trans('main.street_addr_2') }}" value="{{ old('street_address2') }}" />
                </div>

                <div class="form-group">
                    <label for="postal_code" class="control-label">
                        {{ trans('main.postal_code') }}
                        <span class="text-danger">*</span>
                    </label>
                    <input type="text" name="postal_code" id="postal_code" class="form-control"
                           placeholder="{{ trans('main.postal_code') }}" value="{{ old('postal_code') }}" />
                </div>

				<div class="form-group">
					<label class="control-label">
						<p class="help-block">
                            {{ trans('main.clinic_address_help') }}
                            <span class="text-danger">*</span>
                        </p>
					</label>
